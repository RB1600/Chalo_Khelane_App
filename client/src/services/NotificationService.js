...
class NotificationService {
  ...
  registerPushTokenForNewUser = async (userId) => {
    ...
    try {
      ...
      console.log("[PUSH] Updating token on server for user:", userId);
      await axios.put(
      ...
      if (error.message.includes("FirebaseApp is not initialized")) {
        ...
        console.warn("[PUSH] Push notifications disabled: Firebase not initialized (missing google-services.json).");
      } else {
