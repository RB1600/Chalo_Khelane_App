...
// Fallback DNS for SRV resolution issues
...
mongoose
  ...
  .then(async () => {
    ...
    try {
      // TEMPORARY: Drop the old unique index that's causing E11000 errors
      const collection = mongoose.connection.collection('invitations');
      await collection.dropIndex('senderId_1_receiverId_1_tournamentId_1');
      console.log("✅ Successfully dropped old unique index from invitations");
    } catch (e) {
